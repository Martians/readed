...
//        debug!("\t\t\t {} ---> {} {:?}, term {}, index {}, count: {}, [resp]", self.id, m.get_to(),
//               m.get_msg_type(), m.get_term(), m.get_index(), m.entries.len());
    ...
    pub fn send_append(&mut self, to: u64, pr: &mut Progress) {
        ...
        info!("send_append: progress {}, index {}", to, pr.next_idx);
    ...
    pub fn step(&mut self, m: Message) -> Result<()> {
        ...
        debug!("\t\t{} -> {} {:?}, term {}, prev log term {}, index {}, count: {}", m.get_from(), m.get_to(),
               m.get_msg_type(), m.get_term(), m.get_log_term(), m.get_index(), m.entries.len());
        ...
        if m.get_term() == 0 {
            ...
            {
                info!("{} recv prevote with high term!", self.tag);
        ...
        match m.get_msg_type() {
            ...
            MessageType::MsgRequestVote | MessageType::MsgRequestPreVote => {
                ...
                let can_vote = (self.vote == m.get_from()) ||
                    ...
                    // ...or this is a PreVote for a future term...u
