...
void DefaultPolicy::init_options() {
  ...
  file_desc().add_options()
	...
	//("FsBroker.Local.CellStore", boo()->default_value(false), "using local api for cellstore")
	//("FsBroker.Local.CommitLog", boo()->default_value(false), "using local api for commit log")
