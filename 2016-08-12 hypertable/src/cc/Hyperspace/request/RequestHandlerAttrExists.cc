...
/** @file
 * Definitions for RequestHandlerAttrExists.
 * This file contains definitions for RequestHandlerAttrExists, an application
...
void RequestHandlerAttrExists::run() {
  ResponseCallbackAttrExists cb(m_comm, m_event);
  ...
  try {
    ...
    m_master->attr_exists(&cb, m_session_id, handle, name, attr);
  }
  catch (Exception &e) {
