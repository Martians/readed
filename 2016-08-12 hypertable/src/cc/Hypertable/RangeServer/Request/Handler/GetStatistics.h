...
#ifndef Hypertable_RangeServer_Request_Handler_GetStatistics_h
#define Hypertable_RangeServer_Request_Handler_GetStatistics_h
...
namespace Handler {
   ...
   */
  class GetStatistics : public ApplicationHandler {
  public:
...
#endif // Hypertable_RangeServer_Request_Handler_GetStatistics_h
